...
enum class EyeType(
	...
	GEMSTONES(
		16, "gemstone",
		"Instead of regular eyes you see through a pair of gemstones that change hue based on your mood.",
		hasDarkvision = true
	),
	FERAL(
		17, "feral",
		"In your [eyecolor] eyes, sometimes a green light is visibly dancing. Hinting at the beast within. It encompasses your entire pupil when you let it loose.",
		hasDarkvision = true
	),
	GRYPHON(
		18, "gryphon",
		"Your gifted eyes have a bird-like appearance, having an [eyecolor] sclera and a large, black iris. A thin ring of black separates your sclera from your outer iris."
	),
	INFERNAL(
		19, "infernal",
	...
	MINDBREAKER(40, "eldritch",
		"In your hair nests many [eyecolor] eyes, granting you a nearly full peripheral vision. The biggest eye rests on your forehead. It is from this eye that you use your formidable mental powers.",
		hasDarkvision = true
	),
	MINDBREAKERMALE(41, "eldritch male",
		"You have three two [eyecolor], predatory eyes at the front of your head, giving you full sight and perfect perception of what’s in front of you. The eye along your forehead is considerably larger, it is where you channel your formidable mental powers.",
		hasDarkvision = true
	)
	;
